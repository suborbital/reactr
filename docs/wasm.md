...
To create a Wasm runnable, check out the [subo CLI](https://docs.suborbital.dev/subo). Once you've generated a `.wasm` file, you can use it with Reactr just like any other Runnable!
